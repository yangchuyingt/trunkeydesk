...
import com.iiordanov.aSPICE.AbstractConnectionBean;
...
public class ConnectionBean extends AbstractConnectionBean implements Comparable<ConnectionBean> {
    ...
    public ConnectionBean(String username,String password,String kdpport,String HostIp,Context context)
    {
    	setNickname(username);
    	setPassword(password);
    	setPort(Integer.parseInt(kdpport));
    	setAddress(HostIp);
        setConsoleMode(false);
        //setCaCertPath(arg_caCertPath);
        setAutoXWidth(0);
        setRdpHeight(0);
        setViewOnly(false);
        setMenuAnimation(false);
        ...
        setVisualStyles(false);
        setRdpColor(0); 
        setUseRepeater(false);
        setRdpResType(0);
        setAutoXUnixAuth(false);
        setFollowMouse(false);
        setRdpWidth(0);
        setExtraKeysToggleType(1);
        setSshRemoteCommand("0");
        setDesktopComposition(false);
        ...
        setAutoXSessionType(0);
        setSshRemoteCommandType(0);
        setRemoteSoundType(2);
        setConnectionType(0);
        setSecureConnectionType(null);
        setFontSmoothing(false);
        setUseDpadAsArrows(true);
        setUseSshRemoteCommand(false);
        setAutoXType(0);
        ...
        setDesktopBackground(false);
        setWindowContents(false);
        setColorModel("C24bit");
        setMetaListId(1l);
        setForceFull(0l);
        setTlsPort(-1);
        String filename = context.getFilesDir() + "/ca0.pem";
        setCaCertPath(filename);
        setCertSubject(" ");
        c=context;
        setIdHashAlgorithm(Constants.ID_HASH_SHA1);
        setIdHash("");
