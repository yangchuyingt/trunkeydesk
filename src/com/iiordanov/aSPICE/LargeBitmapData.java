...
class LargeBitmapData extends AbstractBitmapData {
    ...
    /* (non-Javadoc)
     * @see com.iiordanov.aSPICE.AbstractBitmapData#copyRect(android.graphics.Rect, android.graphics.Rect, android.graphics.Paint)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.iiordanov.aSPICE.AbstractBitmapData#drawRect(int, int, int, int, android.graphics.Paint)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.iiordanov.aSPICE.AbstractBitmapData#offset(int, int)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.iiordanov.aSPICE.AbstractBitmapData#scrollChanged(int, int)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.iiordanov.aSPICE.AbstractBitmapData#updateBitmap(int, int, int, int)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.iiordanov.aSPICE.AbstractBitmapData#updateBitmap(Bitmap, int, int, int, int)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.iiordanov.aSPICE.AbstractBitmapData#validDraw(int, int, int, int)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.iiordanov.aSPICE.AbstractBitmapData#prepareFullUpdateRequest(boolean)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.iiordanov.aSPICE.AbstractBitmapData#syncScroll()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.iiordanov.aSPICE.AbstractBitmapData#frameBufferSizeChanged(RfbProto)
     */
    @Override
