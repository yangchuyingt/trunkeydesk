...
import com.iiordanov.aSPICE.AbstractMetaKeyBean;
...
public class MetaKeyBean extends AbstractMetaKeyBean implements Comparable<MetaKeyBean> {
    ...
    /* (non-Javadoc)
     * @see com.iiordanov.aSPICE.AbstractMetaKeyBean#getKeyDesc()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.iiordanov.aSPICE.AbstractMetaKeyBean#setKeyDesc(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.iiordanov.aSPICE.AbstractMetaKeyBean#setKeySym(int)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.iiordanov.aSPICE.AbstractMetaKeyBean#setMetaFlags(int)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.iiordanov.aSPICE.AbstractMetaKeyBean#setMouseButtons(int)
     */
    @Override
