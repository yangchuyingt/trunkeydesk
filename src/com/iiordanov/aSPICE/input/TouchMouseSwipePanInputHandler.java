package com.iiordanov.aSPICE.input;
...
public class TouchMouseSwipePanInputHandler extends AbstractGestureInputHandler {
     ...
     * (non-Javadoc)
     * 
     * @see com.iiordanov.aSPICE.AbstractInputHandler#getHandlerDescription()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.iiordanov.aSPICE.AbstractInputHandler#getName()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.iiordanov.aSPICE.VncCanvasActivity.ZoomInputHandler#onKeyDown(int,
     ...
     * (non-Javadoc)
     * 
     * @see com.iiordanov.aSPICE.VncCanvasActivity.ZoomInputHandler#onKeyUp(int,
     *      android.view.KeyEvent)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.iiordanov.aSPICE.AbstractInputHandler#onTrackballEvent(android.view.MotionEvent)
     */
    @Override
    ...
    public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
        ...
        activity.getPanner().start(-(velocityX / FLING_FACTOR),
             ...
             * (non-Javadoc)
             * 
             * @see com.iiordanov.aSPICE.Panner.VelocityUpdater#updateVelocity(android.graphics.Point,
             *      long)
             */
            @Override
