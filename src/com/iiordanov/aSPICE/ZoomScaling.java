...
//        return mode == R.id.itemInputTouchPanZoomMouse;
    ...
    /* (non-Javadoc)
     * @see com.iiordanov.aSPICE.AbstractScaling#zoomIn(com.iiordanov.aSPICE.VncCanvasActivity)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.iiordanov.aSPICE.AbstractScaling#zoomOut(com.iiordanov.aSPICE.VncCanvasActivity)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.iiordanov.aSPICE.AbstractScaling#adjust(com.iiordanov.aSPICE.VncCanvasActivity, float, float, float)
     */
    @Override
