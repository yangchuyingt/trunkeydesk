...
import com.iiordanov.aSPICE.input.Panner;
import com.iiordanov.aSPICE.input.RemoteKeyboard;
import com.iiordanov.aSPICE.input.SimulatedTouchpadInputHandler;
...
*/
    ...
    private void dealreturn() {
		//System.out.println("key_down_times:"+key_down_times+",last_down_time:"+last_down_time+","+((System.currentTimeMillis()-last_down_time)<1000));
		if(key_down_times!=0){
			System.out.println("1");
			if((System.currentTimeMillis()-last_down_time)<2500){
				System.out.println("2");
				key_down_times++;
				
				if(key_down_times==2){
					Toast.makeText(this, "在次点击退出当前云主机", Toast.LENGTH_SHORT).show();
				}
				if(key_down_times==3){
